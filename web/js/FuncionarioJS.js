...
//limpia la información que tiene la tabla
    ...
    body.append("<tr><td colspan=9 ><div id=\"page-nav\"></div></tr></td>");
...
//------------------------------------------------------------------------------dibujar tabla
function dibujarTablaF(dataJson) {
//limpia la información que tiene la tabla
...
//------------------------------------------------------------------------------dibujar fila
function dibuFjarFilaF(rowData) {
//Cuando dibuja la tabla en cada boton se le agrega la funcionalidad de cargar o eliminar la informacion
//de una persona
    ...
    row.append($('<td><center><button type="button" class="btn btn-default btn-xs" aria-label="Left Align" onclick="consultarFuncionariosByID(' + rowData.pkId + ');">' +
...
function eliminarFuncionario(idf) {
...
function enviar() {
    if (validar()) {
        ...
        $.ajax({
            url: 'FuncionarioServlet',
            data: {
                accion: $("#funcionariosAction").val(),
                cedula: $("#ced").val(),
                nombrefun: $("#nomfuncionario").val(),
...
function consultarFuncionariosByID(idf) {
    ...
    $.ajax({
        ...
        success: function (data) { //si todo esta correcto en la respuesta del ajax, la respuesta queda en el data
            ...
            $("#funcionariosAction").val("modificarFuncionario");
...
function limpiarForm() {
    ...
    $("#funcionariosAction").val("agregarFuncionario");
