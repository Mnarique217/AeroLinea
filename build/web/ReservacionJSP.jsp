<%-- 
    Document   : ReservacionJSP
    Created on : 30/05/2017, 02:44:05 M
    Author     : Mario
--%>
...
<html>
    <head>
        ...
        <script src="js/ReservacionJS.js" type="text/javascript"></script>
    ...
    <body class="admin">
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="">
                        <p>¿Estas seguro ?</p>
                        <button type="submit" class="btn btn-danger" id="eliminar" onclick="eliminarReservacion($('#myModalEliminar').attr('data-id'))">Eliminar</button>
        ...
        <div class="container">
            <div class="contenedor">
                <div class="panel">
                    <div class="panel-heading"><h3>Administracion de reservas</h3></div>
                    <div class="panel-body colorRojo">
                        <div class="form-group " >
                            <div class="btn btn-group">
                                <label  for="reservasSelector" >Filtrar</label>
                                <select id="reservasSelector"> 
                            ...
                            <div class="btn btn-group">
                                <input  type="text" class="form-control texMediano" id="buscadorReservas" onkeyup="filtradoReservas();" placeholder="buscar reserva por:">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel">
                    ...
                    <div class='table-responsive '> 
                        <div style="overflow-x:scroll;">
                            <table class="table table-hover table-bordered" id="tablaReservas"></table>
                        </div>
                    </div>
                ...
                <div class="panel colorRojo">
                    <div class="panel-body">
                        <form id="reservasForm">   
                            <div class="col-sm-6" id="groupViaje">
                                <label for="viaje">Viaje</label>
                                <input type="text" class="form-control textBlack"  id="viaje"  placeholder="Click">
                                <input type="hidden"  id="idViaje"/>
                                <select id="selectorViaje" class=""></select>
                            </div>
                            <div class="col-sm-6" id="groupUsuario">
                                <label for="usuario">Usuario</label>
                                <input type="text" class="form-control textBlack" id="usuario" placeholder="bilbao" >
                                <input type="hidden"  id="idUsuario"/>
                                <select id="selectorUsuario"> </select>
                            </div>
                            <div class="col-sm-6" id="groupCantidad">
                                <label for="cant"> No. de Asientos</label>
                                <input type="number" class="form-control textBlack" id="cant" placeholder="asiento(s)" >
                            </div>
                        </form>   

                        <div class="form-group">
                            <div class="btn btn-group">
                                <input type="hidden"  value="agregarReservacion" id="reservacionAction"/>
