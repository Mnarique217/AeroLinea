...
<html>
    <head>
        ...
        <script src="js/FuncionarioJS.js" type="text/javascript"></script>
    </head>
    <body class="admin">
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="">
                        ...
                        <button type="submit" class="btn btn-danger" id="eliminar" onclick="eliminarFuncionario($('#myModalEliminar').attr('data-id'))">Eliminar</button>
        ...
        <div class="modal fade" id="funcionarioModal" role="dialog">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title" id="myModalTitle">Registrar usuario ?</h4>
                    </div>
                    <div class="modal-body" id="myModalMessage">
                        <form role="form" onsubmit="return false;" id="formFuncionarios">
                            ...
                            <div class="form-group">
                                <input type="hidden" value="agregarFuncionario" id="funcionariosAction"/>
        ...
        <div class="container">
            <div class="box">
                <div class="panel">
                    <div class="panel-heading colorRojo"><h3>Administración de funcionarios</h3></div>
